...
$APPLICATION->IncludeComponent('bitrix:main.ui.filter', '', [
    ...
    'FILTER' => [
        ...
        ['id' => 'UF_STATUS', 'name' => 'Статутс', 'type' => 'list', 'items' => ['ALL' => 'Все', 'ACTIVE' => 'Активный', 'CANCELED' => 'Отмененнный', 'COMPLETE' => 'Завершенный'], 'params' => ['multiple' => 'Y']],
...
$APPLICATION->IncludeComponent('bitrix:main.ui.grid', '', [
    ...
    'ROWS' => $arResult['data'], //Самое интересное, опишем ниже
